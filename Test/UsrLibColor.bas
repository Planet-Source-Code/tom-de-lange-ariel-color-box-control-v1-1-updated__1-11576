...
Function HueToRGB(ByVal Tint1 As Long, ByVal Tint2 As Long, ByVal Hue As Long) As Long
'---------------------------------------------------------------------
...
Function Max(t1 As Variant, ParamArray t() As Variant) As Variant
'----------------------------------------------------
...
End Function
Function Min(t1 As Variant, ParamArray t() As Variant) As Variant
'----------------------------------------------------
...
Sub Hue2RGB(Hue As Long, cRed As Long, cGreen As Long, cBlue As Long)
'--------------------------------------------------------------------
'Convert the Hue component to RGB values
'Hue = 0 to 239
'--------------------------------------------------------------------
Dim hb, hi, b

b = MaxHSL \ 6                  'Range for 1 color, 0 to 39 (if MaxHSL=240)
hb = Hue \ b                    'Color Blocks 0 to 5
hi = Hue Mod b                  '0 to 39
Select Case hb
